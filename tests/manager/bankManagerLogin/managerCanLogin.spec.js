...
test('Assert manager can Login', async ({ page }) => {
 ...
 await bankManagerMainPage.assertAddCustomerButtonToBeVisible();
 await bankManagerMainPage.assertOpenAccountButtonToBeVisible();
 await bankManagerMainPage.assertCustomersButtonToBeVisible();
});
